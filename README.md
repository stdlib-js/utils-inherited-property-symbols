...
```javascript
inheritedPropertySymbols = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-inherited-property-symbols@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-inherited-property-symbols/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/utils-inherited-property-symbols/actions/workflows/test.yml?query=branch:v0.1.0
